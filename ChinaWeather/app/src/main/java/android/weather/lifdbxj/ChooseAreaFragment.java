...
import android.weather.lifdbxj.db.City;
import android.weather.lifdbxj.db.County;
import android.weather.lifdbxj.db.Province;
...
public class ChooseAreaFragment extends Fragment {
    ...
    /**
     * 查詢選中市內所有的县，优先从数据库中查询，如果没有查询到再去服务器上查询
     */

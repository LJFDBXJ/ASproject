...
public class CustomMediaController extends MediaController{
    ...
    /**
     *   视频播放控制接口，用于管理视频进度，是vitamio自带的播放控制器mediaplayercontrol
     */
    ...
    /**————————————————————————————————————————————
     *  通过重写次方法，来自定义视频控制器的layout————makeControllerView
     *  然后要通过view的对象来绑定填充布局中的id
     */
    @Override
    ...
    private void initView(View view){
        ...
        findViewById(R.id.btnFastForward).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //快进10秒
                position += 10000;
                //如果快进10秒后，大于等于总的视频长度，则将总长度给当前的位置
        ...
        /**
         *  调整视图(左边调整亮度，右边调整音量)——手指滑动可以调动的范围就是布局中的view控件
         *  通过adjustView对应的区域来调节
         *
         */
        ...
        /**
         * 将adjustview试图调整，进行touch监听
         * 将adjustview绑定手势识别类处理
         * 自己不去判断处理touch具体做了什么，交给GestureDetector去做
         */
        //

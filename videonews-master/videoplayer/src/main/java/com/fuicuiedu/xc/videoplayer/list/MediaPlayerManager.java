package com.fuicuiedu.xc.videoplayer.list;
...
public class MediaPlayerManager {
    ...
    private MediaPlayerManager(Context context) {
        ...
        onPlaybackListenerList = new ArrayList<>();
    }

    /**
     *    接口集合
     */
    private List<OnPlaybackListener> onPlaybackListenerList;
    private Context context;
    private MediaPlayer mediaPlayer;
    //是否需要释放（如果还没有设置数据源的话，release可能出现空指针的情况）
    ...
    private long startTime = 0;//用于避免用户频繁的开关视频

    /**
     *  点击——开始播放，更新UI（通过接口callBack）
     */
    ...
    public void stopPlayer() {
        ...
        //通知UI更新——1.集合的类型 2.集合中某元素的对象 3.集合的对象
        for (OnPlaybackListener listener : onPlaybackListenerList) {
    ...
    /**
     *  缓冲开始,更新UI————如果当前正在播放视频，就停止。然后调用缓冲开始的接口
     */
    ...
    /**
     *     缓冲结束的方法——缓冲结束后，开始播放，根据id停止当前视频的缓冲
     */

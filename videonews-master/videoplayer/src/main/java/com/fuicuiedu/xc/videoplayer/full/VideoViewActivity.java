...
public class VideoViewActivity extends AppCompatActivity {
    ...
    private void initVideoView(){
        ...
        VitamioVV = (VideoView) findViewById(R.id.videoView);
        VitamioVV.setMediaController(new CustomMediaController(this));

        /**
         *  videoview设置屏幕常亮
         *  拿到焦点——是的videoview可以点击
         */
        VitamioVV.setKeepScreenOn(true);
        VitamioVV.requestFocus();
        //缓冲第一步，准备监听中，设置缓冲大小
        VitamioVV.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            @Override
        ...
        VitamioVV.setOnInfoListener(new MediaPlayer.OnInfoListener() {
            @Override
        ...
        VitamioVV.setOnBufferingUpdateListener(new MediaPlayer.OnBufferingUpdateListener() {
            @Override
    ...
    protected void onResume() {
        super.onResume();
        VitamioVV.setVideoPath(getIntent().getStringExtra(KEY_VIDEO_PATH));
    }

package com.fuicuiedu.xc.videonew.ui.news;
...
import com.fuicuiedu.xc.videonew.ui.news.comments.CommentActivity;
...
public class NewsItemView extends BaseItemView<NewsEntity> implements
    ...
    @BindView(R.id.textureView)  /** 展示视频的textView */
            TextureView textureView;

    @BindView(R.id.ivPreview)     /** 黑的预览图*/
            ImageView ivPreview;

    @BindView(R.id.tvNewsTitle)   /** 显示的视频标题*/
            TextView tvNewsTitle;

    @BindView(R.id.tvCreatedAt)   /** 显示视频上传的时间*/
            TextView tvCreatedAt;

    @BindView(R.id.progressBar)    /** 视频加载时候显示的进度条\*/
            ProgressBar progressBar;

    @BindView(R.id.ivPlay)         /**一开始时候显示的播放的图片*/
            ImageView ivPlay;

    private NewsEntity newsEntity; /** 解析出来的新闻实体类数据*/
    ...
    protected void initView() {
        ...
        /**初始化列表播放的管理类——整个recyclerview中只用一个mediaplayer对象来播放视频--------*/
    ...
    public void startPlayer() {
        ...
        String pathl = "http://bmob-cdn-20753.b0.upaiyun.com/2018/07/31/ce26c7b64024498480a7486572f58395.mp4";

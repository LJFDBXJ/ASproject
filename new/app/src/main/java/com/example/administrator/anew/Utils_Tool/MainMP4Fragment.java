...
public class MainMP4Fragment extends Fragment implements TextureView.SurfaceTextureListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mTextureView.setSurfaceTextureListener(this);//设置表面纹理监听
    }
    ...
    public void onSurfaceTextureAvailable(final SurfaceTexture surface, int width, int height) {
       /**
         * 1. 播放什么呢？找到我们播放的资源
         * 2. 可以播放了：MediaPlayer来进行播放 创建、设置播放的资源、设置播放的同异步等。。
        ...
        try {
            ...
            Toast.makeText(getActivity(),"视屏播放失败",Toast.LENGTH_LONG).show();
        }
    }

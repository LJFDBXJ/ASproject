...
// 宝藏的详情页
public class TreasureDetailActivity extends AppCompatActivity implements I_TreasureDetailView {
    ...
    private PopupMenu.OnMenuItemClickListener mMenuItemClickListener = new PopupMenu.OnMenuItemClickListener() {
        ...
        public boolean onMenuItemClick(MenuItem item) {
            ...
            //起点和终点的信息拿到
            // 我们自己的位置和地址
            LatLng start = IMapFragment.getMyLocation();
            String startAddr = IMapFragment.getLocationAddr();

...
import com.feicuiedu.hunttrea.R;
import com.feicuiedu.hunttrea.commons.ActivityUtils;
import com.feicuiedu.hunttrea.custom.TreasureView;
import com.feicuiedu.hunttrea.treasure.Area;
import com.feicuiedu.hunttrea.treasure.Treasure;
import com.feicuiedu.hunttrea.treasure.TreasureRepo;
import com.feicuiedu.hunttrea.treasure.detail.TreasureDetailActivity;
import com.feicuiedu.hunttrea.treasure.hide.IHideTreasureActivity;
...
// 宝藏页面：地图的展示和宝藏数据的展示
public class IMapFragment extends Fragment implements I_MapMvpView {
...
//        }
    ...
    private void initGeoCoder() {
        ...
        // 设置查询结果的监听:地理编码的监听
        mGeoCoder.setOnGetGeoCodeResultListener( getmGeoCoderResultListener() );
    }

    // 地理编码的监听
    private OnGetGeoCoderResultListener getmGeoCoderResultListener() {
        ...
        return mGeoCoderResultListener;
    }
    ...
    private void initLocation() {
        ...
        mLocationClient.registerLocationListener( getmBDLocationListener() );
    ...
    // 定位监听
    private BDLocationListener getmBDLocationListener() {
    ...
    private void initMapView() {
        ...
        // 设置地图上标注物的点击监听
        mBaiduMap.setOnMarkerClickListener( getmOnMarkerClickListener() );
    }

    // 标注物的点击监听
    private BaiduMap.OnMarkerClickListener getmOnMarkerClickListener() {
    ...
    private BaiduMap.OnMapStatusChangeListener mStatusChangeListener = new BaiduMap.OnMapStatusChangeListener() {
        ...
        public void onMapStatusChangeFinish(MapStatus mapStatus) {
            ...
            // 确实地图的状态发生变化了
            if (target != IMapFragment.this.mCurrentStatus) {
                ...
                IMapFragment.this.mCurrentStatus = target;
            }
        }
    };
    ...
    public void hideTreasure() {
        ...
        IHideTreasureActivity.open( getContext(), title, mCurrentAddr, latLng, 0 );
    }

package com.feicuiedu.hunttrea.treasure;
...
import com.feicuiedu.hunttrea.MainActivity;
import com.feicuiedu.hunttrea.R;
import com.feicuiedu.hunttrea.commons.ActivityUtils;
import com.feicuiedu.hunttrea.treasure.list.TreasureListFragment;
import com.feicuiedu.hunttrea.treasure.map.IMapFragment;
import com.feicuiedu.hunttrea.user.UserPrefs;
import com.feicuiedu.hunttrea.user.account.AccountActivity;
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMapFragment = (IMapFragment) mSupportFragmentManager.findFragmentById( R.id.mapFragment );
        ...
        mIvIcon = mNavigationView.getHeaderView( 0 ).findViewById( R.id.iv_usericon );

...
public class TreasureRepo {
    ...
    /**
     * 1  List<Treasure> list = new ArrayList<>();
     * 1  list.addAll( treasureMap.values() );
     *
     * 2 redundant:   List<Treasure> list = new ArrayList<>( treasureMap.values() );
     *
     * 3 final :return new ArrayList<>( treasureMap.values() );
     */

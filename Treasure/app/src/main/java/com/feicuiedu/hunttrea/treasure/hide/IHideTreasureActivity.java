...
public class IHideTreasureActivity extends AppCompatActivity implements I_HideTreasureView {
    ...
    public static void open(Context context, String title, String address, LatLng latLng, double altitude) {
        mContext = context;
        Intent intent = new Intent(context, IHideTreasureActivity.class);

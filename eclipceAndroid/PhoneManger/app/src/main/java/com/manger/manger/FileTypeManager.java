...
public class FileTypeManager {
	/** 任意文件类型 */
	public static final String TYPE_ANY = "  KEY_ANY ";
	/** 文本文件类型 */
	public static final String TYPE_TXT = "  KEY_TXT  ";
	/** 图像文件类型 */
	public static final String TYPE_IMAGE =  "KEY_IMAGE";
	public static final String TYPE_VIDEO =  " KEY_VIDEO";
	public static final String TYPE_AUDIO =  " KEY_AUDIO";
	public static final String TYPE_ZIP =    " KEY_ZIP  ";
	public static final String TYPE_APK =    " KEY_APK  ";

	/** 获取文件图标及类型 {@link #ICON_TYPE_Table} */

	public static String[] getFileIconAndTypeName(File targetFile) {
		String[] iconAndTypes = new String[2];
		iconAndTypes[0] = "icon_file";
		iconAndTypes[1] = TYPE_ANY;
		// 是文件
	...
	/** 保存着文件后缀名+图标+类型的对照表数组, 其中文件类型{@link #TYPE_ANY等} */
	 ...
	 * @param targetFile
	 */
	public static String getMIMEType(File targetFile) {
		String type = "*/*";
